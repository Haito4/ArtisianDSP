...
namespace Gui
{
    ...
    public:
        ...
        void resized() override
        {
            ...
            auto leftBounds = bounds.removeFromLeft(container.proportionOfWidth(0.2f)).reduced(4);
            saveButton.setBounds(leftBounds);

            leftBounds = bounds.removeFromLeft(container.proportionOfWidth(0.1f)).reduced(4);
            previousPresetButton.setBounds(leftBounds);

            leftBounds = bounds.removeFromLeft(container.proportionOfWidth(0.4f)).reduced(4);
            presetList.setBounds(leftBounds);

            leftBounds = bounds.removeFromLeft(container.proportionOfWidth(0.1f)).reduced(4);
            nextPresetButton.setBounds(leftBounds);
